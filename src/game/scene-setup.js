const SceneSetupMethods={
  initSceneState(){
    ...
    this.enemyWaypoints=ctx.enemyWaypoints||[];
  ...
  resetRunState(){
    ...
    this.wS=0;
    this.wActive=false;
    this._waveSpawnDone=false;
    this._pendingWaveClears=[];
    this._allLevelWavesSpawned=false;
    this._waveNaturalDuration=PREP_TIME;
    this._waveSpawnElapsed=0;
